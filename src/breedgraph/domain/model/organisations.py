...
from .base import Aggregate, Member, MemberStored, MappedHierarchy

logger = logging.getLogger(__name__)

class TeamBase(Member):
    name: str
    fullname: str
...
class TeamStored(TeamBase, MemberStored):
...
class Organisation(MappedHierarchy):
    members: Dict[int, TeamInput|TeamStored] = dict()
    ...
    #    self.teams[team.parent].children.append(temp_id)
    #    return temp_id
    ...
    #        self.teams[team.parent].children.remove(team_id)
