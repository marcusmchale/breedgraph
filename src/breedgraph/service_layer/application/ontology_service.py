...
from typing import Set, List, Tuple, Dict, Any, AsyncGenerator, overload, Literal
...
class OntologyApplicationService:
    ...
    @overload
    async def _create_entry(self, entry: GermplasmMethodInput, **kwargs) -> GermplasmMethodStored: ...
    @overload
    ...
    async def create_entry(
            ...
            entry: SubjectInput|TermInput|ObservationMethodInput|\
                   ScaleCategoryInput|ControlMethodInput|GermplasmMethodInput|\
    ...
    @overload
    async def get_entry(self, entry_id: int = None, name: str = None, *, label: Literal["ObservationMethod"], as_output: Literal[False] = False) -> ObservationMethodStored|None: ...
    @overload
    ...
    @overload
    async def get_entry(self, entry_id: int = None, name: str = None, *, label: Literal["ScaleCategory"], as_output: Literal[False] = False) -> ScaleCategoryStored|None: ...
    @overload
    async def get_entry(self, entry_id: int = None, name: str = None, *, label: Literal["ControlMethod"], as_output: Literal[False] = False) -> ControlMethodStored|None: ...
    @overload
    async def get_entry(self, entry_id: int = None, name: str = None, *, label: Literal["GermplasmMethod"], as_output: Literal[False] = False) -> GermplasmMethodStored|None: ...
    @overload
    async def get_entry(self, entry_id: int = None, name: str = None, *, label: Literal["LocationType"], as_output: Literal[False] = False) -> LocationTypeStored|None: ...
    @overload
    async def get_entry(self, entry_id: int = None, name: str = None, *, label: Literal["LayoutType"], as_output: Literal[False] = False) -> LayoutTypeStored|None: ...
    @overload
    ...
    @overload
    async def get_entry(self, entry_id: int = None, name: str = None, *, label: Literal["EventType"], as_output: Literal[False] = False) -> EventTypeStored|None: ...
    ...
    @overload
    async def get_entry(self, entry_id: int = None, name: str = None, *, label: Literal["ObservationMethod"], as_output: Literal[True]) -> ObservationMethodOutput|None: ...
    @overload
    ...
    @overload
    async def get_entry(self, entry_id: int = None, name: str = None, *, label: Literal["ScaleCategory"], as_output: Literal[True]) -> ScaleCategoryOutput|None: ...
    @overload
    async def get_entry(self, entry_id: int = None, name: str = None, *, label: Literal["ControlMethod"], as_output: Literal[True]) -> ControlMethodOutput|None: ...
    @overload
    async def get_entry(self, entry_id: int = None, name: str = None, *, label: Literal["GermplasmMethod"], as_output: Literal[True]) -> GermplasmMethodOutput|None: ...
    @overload
    async def get_entry(self, entry_id: int = None, name: str = None, *, label: Literal["LocationType"], as_output: Literal[True]) -> LocationTypeOutput|None: ...
    @overload
    async def get_entry(self, entry_id: int = None, name: str = None, *, label: Literal["LayoutType"], as_output: Literal[True]) -> LayoutTypeOutput|None: ...
    @overload
    ...
    @overload
    async def get_entry(self, entry_id: int = None, name: str = None, *, label: Literal["EventType"], as_output: Literal[True]) -> EventTypeOutput|None: ...
    
    @overload
    async def get_entry(self, entry_id: int = None, name: str = None, label: str = None, as_output: Literal[False] = False) -> OntologyEntryStored|None: ...
    @overload
    async def get_entry(self, entry_id: int = None, name: str = None, label: str = None, as_output: Literal[True] = False) -> OntologyEntryOutput|None: ...

    async def get_entry(self, entry_id: int = None, name: str = None, label: str = None, as_output: bool = False) -> OntologyEntryStored|OntologyEntryOutput|None:
    ...
    async def _validate_entry_types_for_relationship(
        ...
        if relationship.label is OntologyRelationshipLabel.PARENT_OF:
            ...
            valid_combinations = {
                OntologyRelationshipLabel.HAS_CATEGORY: (["Scale"], ["Category"]),
                OntologyRelationshipLabel.DESCRIBES_SUBJECT: (["Trait", "Condition"], ["Subject"]),
                OntologyRelationshipLabel.DESCRIBES_TRAIT: (["Variable"], ["Trait"]),
                OntologyRelationshipLabel.DESCRIBES_CONDITION: (["Factor"], ["Condition"]),
                OntologyRelationshipLabel.USES_CONTROL_METHOD: (["Factor"], ["ControlMethod"]),
                OntologyRelationshipLabel.USES_OBSERVATION_METHOD: (["Variable"], "ObservationMethod"),
                OntologyRelationshipLabel.USES_SCALE: (["Variable", "Factor"], ["Scale"]),
                OntologyRelationshipLabel.DESCRIBES_FACTOR: (["Event"], ["Factor"]),
                OntologyRelationshipLabel.DESCRIBES_VARIABLE: (["Event"], ["Variable"]),
            }
    ...
    async def activate_relationship(
        ...
        """Commit a draft entry."""
        lifecycle = self._get_relationship_lifecycle(entry_id)
        lifecycle.set_version_activated(version)
        await self._save_entry_lifecycles()
    ...
    async def add_scale_categories(
        ...
        scale = await self.get_entry(entry_id=scale_id, label="Scale")
