...
from dbtools.domain.model import AffiliationLevel
...
from . import command_resolvers, query_resolvers  # need to import these here as using decorators
...
graphql_schema = make_executable_schema(
		load_schema_from_path("adapters/graphql"),
		graphql_query,
		graphql_mutation,
		snake_case_fallback_resolvers,
		affiliation_level
