...
async def test_create_variable(
    ...
    assert variable_payload.get('result')[0].get('trait').get('id') == str(trait_id)
    assert variable_payload.get('result')[0].get('observationMethod').get('id') == str(method_id)
    assert variable_payload.get('result')[0].get('scale').get('id') == str(scale_id)
...
async def test_commit_version(
    ...
    assert payload.get('result')[0].get('user').get('id') == str(user_id)
